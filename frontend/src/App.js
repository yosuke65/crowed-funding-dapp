...
const App = () => {
  ...
  const checkIfWalletIsConnected = async () => {
    try {
      ...
      if (solana) {
        ...
        alert("Solana wallet not found! Get a Phantom wallet and try again.");
      }
    } catch (error) {
      console.error(error);
    }
  ...
  const donate = async (publicKey) => {
    try {
      ...
      console.log("Donated some money to campaign: ", publicKey.toString());
      getCampaigns();
    } catch (error) {
  ...
  const withdraw = async (publicKey) => {
    try {
      ...
      console.log("Withdraw some money from campaign: ", publicKey.toString());
      getCampaigns();
    } catch (error) {
